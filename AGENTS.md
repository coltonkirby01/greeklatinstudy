...
- `latin-participles` is a separate built-in four-card deck under Grammar (Henle) → Participles. Its four stable cards teach Present Active, Perfect Passive, Future Active, and Future Passive participle formation and declension, in that order. Present Active and Future Passive use the present stem derived from the **second** principal part; Perfect Passive and Future Active use the **fourth** principal part. Future Active uses `-ūrus, -ūra, -ūrum`; Future Passive uses `-ndus, -nda, -ndum` and is also called the gerundive. Preserve conjugation-specific connecting vowels, the correct Latin examples, shared exact-card selection/Deselect/Shuffle, Saved Cards, and Stats. These are textual formation cards, not audio paradigms; do not automatically generate TTS for them.
