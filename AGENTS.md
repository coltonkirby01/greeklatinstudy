...
- Every built-in card must also be individually selectable from the language-level Choose cards menu. Exact-card selection and the answer-side Deselect action use the same persistent per-card exclusion state; they are not parallel selection systems.
